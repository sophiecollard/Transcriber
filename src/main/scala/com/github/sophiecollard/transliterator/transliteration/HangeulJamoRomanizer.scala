...
object HangeulJamoRomanizer {
  ...
  def transliterateInitial(jamo: HangeulJamo.Initial): Vector[RomanLetter] =
    jamo match {
      ...
      case HangeulJamo.Initial.ㅇ => Vector.empty // Silent when in initial position
  ...
  def transliterateFinal(jamo: HangeulJamo.Final): Vector[RomanLetter] =
    jamo match {
      ...
      case HangeulJamo.Final.ㄳ => transliterateFinal(HangeulJamo.Final.ㄱ)
      case HangeulJamo.Final.ㄴ => Vector(N)
      case HangeulJamo.Final.ㄵ => transliterateFinal(HangeulJamo.Final.ㄴ)
      case HangeulJamo.Final.ㄶ => transliterateFinal(HangeulJamo.Final.ㄴ)
      case HangeulJamo.Final.ㄷ => Vector(T)
      case HangeulJamo.Final.ㄹ => Vector(L)
      case HangeulJamo.Final.ㄺ => transliterateFinal(HangeulJamo.Final.ㄱ)
      case HangeulJamo.Final.ㄻ => transliterateFinal(HangeulJamo.Final.ㅁ)
      case HangeulJamo.Final.ㄼ => transliterateFinal(HangeulJamo.Final.ㅂ)
      case HangeulJamo.Final.ㄽ => transliterateFinal(HangeulJamo.Final.ㄹ)
      case HangeulJamo.Final.ㄾ => transliterateFinal(HangeulJamo.Final.ㄹ)
      case HangeulJamo.Final.ㄿ => transliterateFinal(HangeulJamo.Final.ㅍ) // Sometimes also ㅂ
      case HangeulJamo.Final.ㅀ => transliterateFinal(HangeulJamo.Final.ㄹ)
      case HangeulJamo.Final.ㅁ => Vector(M)
      case HangeulJamo.Final.ㅂ => Vector(P)
      case HangeulJamo.Final.ㅄ => transliterateFinal(HangeulJamo.Final.ㅂ)
