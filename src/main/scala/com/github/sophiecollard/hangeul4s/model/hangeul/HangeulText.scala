...
import com.github.sophiecollard.hangeul4s.parsing.{AccumulativeParser, AccumulativeParsingResult}
  ...
  val parser: AccumulativeParser[HangeulText] =
    AccumulativeParser.instance[HangeulText] { input =>
      splittingRegex
        ...
        .traverse[AccumulativeParsingResult, HangeulTextElement](identity)
